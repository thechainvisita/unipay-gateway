...
export default function MerchantNavbar() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#071426] to-[#042b36] border-b border-white/10 p-4 shadow-md mt-2">
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            ...
            >
              ...
              <span className="truncate font-aeonik max-w-[160px]">
            ...
            {dropdownOpen && (
              <div
                ref={dropdownRef}
                className="absolute right-0 mt-2 w-44 bg-[#0f1720] font-aeonik text-white border border-white/10 rounded-lg p-2 shadow z-50"
              >
                <button
      ...
      {menuOpen && (
        <div className="md:hidden mt-2 bg-[#0f1720] border border-white/10 rounded-lg p-4 shadow text-md space-y-2 font-aeonik text-white">
          <button
